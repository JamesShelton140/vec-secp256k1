// vector subtraction and reduction
...
// <q1',q2',q3',q4'> ← Add(<n1',n2',n3',n4'>, Negate(<p1',p2',p3',p4'>))
vpaddd      neg_p0,%ymm0,%ymm0
vpxor       neg_xor,%ymm5,%ymm5
vpaddd      %ymm0,%ymm5,%ymm10

vpaddd      neg_p1,%ymm1,%ymm1
vpxor       neg_xor,%ymm6,%ymm6
vpaddd      %ymm1,%ymm6,%ymm11

vpaddd      neg_p23,%ymm2,%ymm2
vpxor       neg_xor,%ymm7,%ymm7
vpaddd      %ymm2,%ymm7,%ymm12

vpaddd      neg_p23,%ymm3,%ymm3
vpxor       neg_xor,%ymm8,%ymm8
vpaddd      %ymm3,%ymm8,%ymm13

vpaddd      neg_p4,%ymm4,%ymm4
vpxor       neg_xor,%ymm9,%ymm9
vpaddd      %ymm4,%ymm9,%ymm14
